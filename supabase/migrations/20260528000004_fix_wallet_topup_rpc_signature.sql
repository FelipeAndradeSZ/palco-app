...
drop function if exists public.credit_wallet_topup(text, uuid, numeric);
drop function if exists public.credit_wallet_topup(text, numeric, uuid);
...
grant execute on function public.credit_wallet_topup(text, numeric, uuid) to authenticated;
